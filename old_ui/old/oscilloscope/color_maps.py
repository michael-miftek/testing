...
"""!
@package Color Maps
This file has a list of each color map that is or can be used for the different visuals in the
software
"""
...
class colormaps:
    """!
    Color map class initialization

    """
    def __init__(self):
        self.turbo = turbo_colormap_data * 255
        self.channel_colors = channel_colors * 255
