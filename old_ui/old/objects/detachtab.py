    ...
    class TabBar(QtWidgets.QTabBar):
        ...
        def mouseMoveEvent(self, event):
            ...
            if (((event.buttons() & QtCore.Qt.MouseButton.LeftButton)) and self.dragInitiated):
                ...
                finishMoveEvent = QtGui.QMouseEvent(QtCore.QEvent.Type.MouseMove, pos, QtCore.Qt.MouseButton.NoButton,
        ...
        def dropEvent(self, event):
            self.dragDropedPos = QtCore.QPoint(int(event.position().x()), int(event.position().y()))
